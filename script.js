...
function calculateResults() {
    ...
    surveyData.categories.forEach(category => {
        ...
        const categoryRange = category.scoringRanges ? 
...
function loadSurveyData() {
    ...
    if (saved) {
        ...
        // Check if the loaded data has the required scoringRanges
        if (!surveyData.scoringRanges || surveyData.scoringRanges.length === 0) {
            console.log('Loaded data missing global scoring ranges, reloading defaults');
